...
public class Practica1_PacMan {
    ...
    public static void main(String[] args) {
        ...
        String nombreSave[] = new String[9]; 
        
        do{

        //Variables para inicio de juego
        String nombre;
        int filas, columnas, comida, paredes, trampas, icono;
        int cantComida, cantParedes, cantTrampas;

        //Variables para posicion de objetos
        int contadorComida1 = 0, contadorComida2 = 0, contadorParedes = 0, contadorTrampas = 0;
        int comida1_x, comida1_y, comida2_x, comida2_y, comidaT1, comidaT2;
        int pared_x, pared_y;
        int trampa_x, trampa_y;

        //Variables al momento de estar jugando
        int punteo = 0, vidas = 3;
